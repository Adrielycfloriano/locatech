...
public class AluguelController {
    ...
    // http://localhost:8080/alugueis/1 patchvariable
    // http://localhost:8080/alugueis?page=1&size=10 requestparam

    @GetMapping
    public ResponseEntity<List<Aluguel>> findAllsAluguel(
